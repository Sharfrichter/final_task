...
public class StatementProxy implements PreparedStatement {
    private PreparedStatement statement;

    public StatementProxy(PreparedStatement statement) {
        this.statement = statement;
    }

    public void setValue(int parameterIndex, Object x) throws SQLException {
